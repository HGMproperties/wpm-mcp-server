...
import {
  EpaysettingCreateParams,
  EpaysettingCreateResponse,
  EpaysettingListResponse,
  Epaysettings,
} from './epaysettings';
...
export interface Rental {
   ...
   */
  RentalManager?: Rental.RentalManager | null;
...
export interface RentalCreateParams {
   ...
   * Address.
   */
  Address: RentalCreateParams.Address;
...
export interface RentalUpdateParams {
   ...
   * Address.
   */
  Address: RentalUpdateParams.Address;
...
export namespace RentalUpdateParams {
  /**
   * Address.
   */
  export interface Address {
