...
export interface RentalOwner {
   ...
   * Address.
   */
  Address?: RentalOwner.Address | null;
...
export interface OwnerCreateParams {
   ...
   * Address.
   */
  Address: OwnerCreateParams.Address;
   ...
   * Phone numbers.
   */
  PhoneNumbers?: OwnerCreateParams.PhoneNumbers | null;

  /**
   * Tax information.
   */
  TaxInformation?: OwnerCreateParams.TaxInformation | null;
}
...
export interface OwnerUpdateParams {
   ...
   * Address.
   */
  Address: OwnerUpdateParams.Address;
   ...
   * Phone numbers.
   */
  PhoneNumbers?: OwnerUpdateParams.PhoneNumbers | null;
}
