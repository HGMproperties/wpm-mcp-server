...
export class Notes extends APIResource {
   ...
   * ```ts
   * const note =
   *   await client.associations.ownershipaccounts.notes.create(
   *     0,
   *     { Note: 'x' },
   *   );
   * ```
  ...
  ): APIPromise<NotesAPI.Note> {
    return this._client.post(path`/v1/associations/ownershipaccounts/${ownershipAccountID}/notes`, {
      body,
      ...options,
    });
  }
   ...
   * ```ts
   * const note =
   *   await client.associations.ownershipaccounts.notes.retrieve(
   *     0,
  ...
  retrieve(noteID: number, params: NoteRetrieveParams, options?: RequestOptions): APIPromise<NotesAPI.Note> {
    ...
    return this._client.get(
      path`/v1/associations/ownershipaccounts/${ownershipAccountId}/notes/${noteID}`,
      options,
    );
  }
   ...
   * ```ts
   * const note =
   *   await client.associations.ownershipaccounts.notes.update(
   *     0,
   *     { ownershipAccountId: 0, Note: 'x' },
   *   );
   * ```
   */
  update(noteID: number, params: NoteUpdateParams, options?: RequestOptions): APIPromise<NotesAPI.Note> {
    ...
    return this._client.put(path`/v1/associations/ownershipaccounts/${ownershipAccountId}/notes/${noteID}`, {
      body,
      ...options,
    });
  }
   ...
   * ```ts
   * const notes =
   *   await client.associations.ownershipaccounts.notes.list(0);
   * ```
   */
  list(
    ownershipAccountID: number,
    ...
    return this._client.get(path`/v1/associations/ownershipaccounts/${ownershipAccountID}/notes`, {
      query,
      ...options,
    });
  }
