...
import { APIPromise } from 'wpm-mcp-server/core/api-promise';

import util from 'node:util';
import WpmMcpServer from 'wpm-mcp-server';
import { APIUserAbortError } from 'wpm-mcp-server';
...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['WPM_MCP_SERVER_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: WpmMcpServer) => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['WPM_MCP_SERVER_BASE_URL'] = undefined;
    });
