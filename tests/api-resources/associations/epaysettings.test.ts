...
describe('resource epaysettings', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.associations.epaysettings.retrieve(0);
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.associations.epaysettings.update(0, {
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.associations.epaysettings.update(0, {
      CreditCardPayments: { PaymentsEnabled: true },
      EFTPayments: { PaymentsEnabled: true },
      OfflinePayments: {
