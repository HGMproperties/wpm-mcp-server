...
describe('resource tenants', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.associations.tenants.create({
      FirstName: 'x',
      LastName: 'x',
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.associations.tenants.create({
      FirstName: 'x',
      LastName: 'x',
      OwnershipAccountId: 0,
      PrimaryAddress: {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.associations.tenants.retrieve(0);
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.associations.tenants.update(0, {
      FirstName: 'x',
      LastName: 'x',
      PrimaryAddress: { AddressLine1: 'x', Country: 'Afghanistan', PostalCode: 'x' },
    });
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.associations.tenants.update(0, {
      FirstName: 'x',
      LastName: 'x',
      PrimaryAddress: {
        AddressLine1: 'x',
  ...
  test.skip('list', async () => {
    const responsePromise = client.associations.tenants.list();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.associations.tenants.list(
        {
          associationids: [0],
