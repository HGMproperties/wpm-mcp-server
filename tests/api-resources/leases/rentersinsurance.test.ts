...
describe('resource rentersinsurance', () => {
  // skipped: tests are disabled for the time being
  test.skip('retrieve: only required params', async () => {
    const responsePromise = client.leases.rentersinsurance.retrieve(0, { leaseId: 0 });
  ...
  test.skip('retrieve: required and optional params', async () => {
    const response = await client.leases.rentersinsurance.retrieve(0, { leaseId: 0 });
  });
