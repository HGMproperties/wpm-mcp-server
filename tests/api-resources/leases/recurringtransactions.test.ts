...
describe('resource recurringtransactions', () => {
  ...
  test.skip('list', async () => {
    const responsePromise = client.leases.recurringtransactions.list(0);
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.leases.recurringtransactions.list(
        0,
  ...
  test.skip('listAll', async () => {
    const responsePromise = client.leases.recurringtransactions.listAll();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('listAll: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.leases.recurringtransactions.listAll(
        {
