import fs from 'fs';
import type { ResponseLike } from 'wpm-mcp-server/internal/to-file';
import { toFile } from 'wpm-mcp-server/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('wpm-mcp-server/core/uploads');
    await expect(
