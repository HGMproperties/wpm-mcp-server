...
import { ClientOptions } from 'wpm-mcp-server';
...
export { ClientOptions } from 'wpm-mcp-server';
...
export function initMcpServer(params: {
  ...
  const client = new WpmMcpServer(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new WpmMcpServer({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
