...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/applicants/{applicantId}/applications',
  operationId: 'ExternalApiApplicantApplications_GetApplicationsForApplicant',
};

export const tool: Tool = {
  name: 'list_applicants_applications',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.applicants.applications.list(applicantId, body));
};
