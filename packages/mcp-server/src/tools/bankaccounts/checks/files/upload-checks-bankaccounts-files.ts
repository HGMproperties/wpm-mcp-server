...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/bankaccounts/{bankAccountId}/checks/{checkId}/files/uploadrequests',
  operationId: 'ExternalApiBankAccountCheckFileUploads_CreateCheckUploadFileRequest',
};

export const tool: Tool = {
  name: 'upload_checks_bankaccounts_files',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.bankaccounts.checks.files.upload(checkId, body));
};
