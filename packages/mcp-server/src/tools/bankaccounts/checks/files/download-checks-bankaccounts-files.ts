...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/bankaccounts/{bankAccountId}/checks/{checkId}/files/{fileId}/downloadrequests',
  operationId: 'ExternalApiBankAccountCheckFileDownloadRequests_DownloadCheckFile',
};

export const tool: Tool = {
  name: 'download_checks_bankaccounts_files',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.bankaccounts.checks.files.download(fileId, body));
};
