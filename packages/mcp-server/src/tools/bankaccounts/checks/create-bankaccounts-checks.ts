...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/bankaccounts/{bankAccountId}/checks',
  operationId: 'ExternalApiBankAccountChecks_CreateBankAccountCheck',
};

export const tool: Tool = {
  name: 'create_bankaccounts_checks',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.bankaccounts.checks.create(bankAccountId, body));
};
