...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/bankaccounts/{bankAccountId}/undepositedfunds',
  operationId: 'ExternalApiBankAccountUndepositedFunds_GetUndepositedFunds',
};

export const tool: Tool = {
  name: 'retrieve_undeposited_funds_bankaccounts',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.bankaccounts.retrieveUndepositedFunds(bankAccountId, body));
};
