...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/bankaccounts/{bankAccountId}/transactions',
  operationId: 'ExternalApiBankAccountTransactions_GetBankAccountTransactions',
};

export const tool: Tool = {
  name: 'list_bankaccounts_transactions',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.bankaccounts.transactions.list(bankAccountId, body));
};
