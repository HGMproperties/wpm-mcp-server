...
export const tool: Tool = {
  name: 'uncleartransactionsrequest_bankaccounts_reconciliations',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  await client.bankaccounts.reconciliations.uncleartransactionsrequest(reconciliationId, body);
