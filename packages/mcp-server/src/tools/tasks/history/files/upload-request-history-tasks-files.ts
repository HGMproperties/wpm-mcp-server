...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/tasks/{taskId}/history/{taskHistoryId}/files/uploadrequests',
  operationId: 'ExternalApiTaskHistoryFileUploads_CreateUploadFileRequestAsync',
};

export const tool: Tool = {
  name: 'upload_request_history_tasks_files',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.tasks.history.files.uploadRequest(taskHistoryId, body));
};
