...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/generalledger/journalentries',
  operationId: 'ExternalApiGeneralLedgerJournalEntries_CreateGeneralJournalEntry',
};

export const tool: Tool = {
  name: 'create_generalledger_journalentries',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.generalledger.journalentries.create(body));
};
