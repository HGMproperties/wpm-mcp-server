...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/associations/ownershipaccounts/{ownershipAccountId}/recurringpayments',
  operationId: 'ExternalApiOwnershipAccountRecurringPayments_CreateOwnershipAccountRecurringPayment',
};

export const tool: Tool = {
  name: 'create_ownershipaccounts_associations_recurringpayments',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await client.associations.ownershipaccounts.recurringpayments.create(ownershipAccountId, body),
  );
};
