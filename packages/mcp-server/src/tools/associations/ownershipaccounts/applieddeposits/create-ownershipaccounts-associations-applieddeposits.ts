...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/associations/ownershipaccounts/{ownershipAccountId}/applieddeposits',
  operationId: 'ExternalApiOwnershipAccountDepositWithholding_CreateOwnershipAccountDepositWithholding',
};

export const tool: Tool = {
  name: 'create_ownershipaccounts_associations_applieddeposits',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await client.associations.ownershipaccounts.applieddeposits.create(ownershipAccountId, body),
  );
};
