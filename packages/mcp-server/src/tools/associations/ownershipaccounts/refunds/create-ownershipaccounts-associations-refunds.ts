...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/associations/ownershipaccounts/{ownershipAccountId}/refunds',
  operationId: 'ExternalApiOwnershipAccountRefund_CreateOwnershipAccountRefund',
};

export const tool: Tool = {
  name: 'create_ownershipaccounts_associations_refunds',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await client.associations.ownershipaccounts.refunds.create(ownershipAccountId, body),
  );
};
