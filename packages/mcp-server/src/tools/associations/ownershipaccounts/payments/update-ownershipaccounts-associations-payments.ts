...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/v1/associations/ownershipaccounts/{ownershipAccountId}/payments/{paymentId}',
  operationId: 'ExternalApiOwnershipAccountLedgerPayments_UpdateOwnershipAccountLedgerPayment',
};

export const tool: Tool = {
  name: 'update_ownershipaccounts_associations_payments',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.associations.ownershipaccounts.payments.update(paymentId, body));
};
