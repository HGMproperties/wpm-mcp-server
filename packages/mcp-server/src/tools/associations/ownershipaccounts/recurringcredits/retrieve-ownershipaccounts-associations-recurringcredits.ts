...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/associations/ownershipaccounts/{ownershipAccountId}/recurringcredits/{transactionId}',
  operationId: 'ExternalApiOwnershipAccountRecurringCredits_GetOwnershipAccountRecurringCreditById',
};

export const tool: Tool = {
  name: 'retrieve_ownershipaccounts_associations_recurringcredits',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await client.associations.ownershipaccounts.recurringcredits.retrieve(transactionId, body),
  );
};
