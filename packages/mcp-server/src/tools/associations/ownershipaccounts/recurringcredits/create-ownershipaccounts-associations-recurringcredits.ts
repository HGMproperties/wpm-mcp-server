...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/associations/ownershipaccounts/{ownershipAccountId}/recurringcredits',
  operationId: 'ExternalApiOwnershipAccountRecurringCredits_CreateOwnershipAccountCreditRecurringTransaction',
};

export const tool: Tool = {
  name: 'create_ownershipaccounts_associations_recurringcredits',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await client.associations.ownershipaccounts.recurringcredits.create(ownershipAccountId, body),
  );
};
