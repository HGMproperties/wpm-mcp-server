...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/associations/tenants/{tenantId}/notes',
  operationId: 'ExternalApiAssociationTenantNotes_CreateAssociationTenantNote',
};

export const tool: Tool = {
  name: 'create_tenants_associations_notes',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.associations.tenants.notes.create(tenantId, body));
};
