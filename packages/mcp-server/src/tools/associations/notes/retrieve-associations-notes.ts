...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/associations/{associationId}/notes/{noteId}',
  operationId: 'ExternalApiAssociationNotes_GetAssociationNoteByNoteId',
};

export const tool: Tool = {
  name: 'retrieve_associations_notes',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.associations.notes.retrieve(noteId, body));
};
