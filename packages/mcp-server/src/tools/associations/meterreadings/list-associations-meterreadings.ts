...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/associations/{associationId}/meterreadings',
  operationId: 'ExternalApiAssociationMeterReadingsRead_GetMeterReadingsForAssociation',
};

export const tool: Tool = {
  name: 'list_associations_meterreadings',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.associations.meterreadings.list(associationId, body));
};
