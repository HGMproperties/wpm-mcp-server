...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/associations/banklockboxdata',
  operationId: 'ExternalApiAssociationBankLockBoxData_GetBankLockBoxData',
};

export const tool: Tool = {
  name: 'list_bank_lockbox_data_associations',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.associations.listBankLockboxData(body));
};
