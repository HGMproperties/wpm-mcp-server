...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/leases/{leaseId}/recurringtransactions',
  operationId: 'ExternalApiLeaseRecurringTransactions_GetLeaseRecurringTransactions',
};

export const tool: Tool = {
  name: 'list_leases_recurringtransactions',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.leases.recurringtransactions.list(leaseId, body));
};
