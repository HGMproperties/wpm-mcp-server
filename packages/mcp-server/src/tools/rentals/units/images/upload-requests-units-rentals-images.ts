...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/rentals/units/{unitId}/images/uploadrequests',
  operationId: 'ExternalApiRentalUnitImageUploadRequests_CreateUploadFileRequestAsync',
};

export const tool: Tool = {
  name: 'upload_requests_units_rentals_images',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.rentals.units.images.uploadRequests(unitId, body));
};
