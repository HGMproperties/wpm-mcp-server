...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/rentals/appliances/{applianceId}/servicehistory',
  operationId: 'ExternalApiRentalApplianceServiceHistory_CreateRentalApplianceServiceHistory',
};

export const tool: Tool = {
  name: 'create_appliances_rentals_servicehistory',
  description:
...
export const handler = async (client: WpmMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.rentals.appliances.servicehistory.create(applianceId, body));
};
